# Monólita (`Monolita`) Font | (Holloway) Chew, Kean Ho's Creative Visuals
...
```
Title: Monólita (Monolita) Font
Creators: The Monólita Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-monolita
UUID: D859351B-E89C-4539-9313-B3AE05F2752D
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-monolita
```
